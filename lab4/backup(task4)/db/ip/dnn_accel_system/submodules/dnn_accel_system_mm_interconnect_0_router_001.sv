...
(
    ...
    localparam PAD1 = log2ceil(64'h1030 - 64'h1020); 
    localparam PAD2 = log2ceil(64'h2800 - 64'h2000); 
    localparam PAD3 = log2ceil(64'h4000040 - 64'h4000000); 
    // -------------------------------------------------------
    // Work out which address bits are significant based on the
    // address range of the slaves. If the required width is too
    // large or too small, we use the address field width instead.
    // -------------------------------------------------------
    localparam ADDR_RANGE = 64'h4000040;
    ...
    // ( 0x1020 .. 0x1030 )
    if ( {address[RG:PAD1],{PAD1{1'b0}}} == 27'h1020   ) begin
            src_channel = 6'b1000;
