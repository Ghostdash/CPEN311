...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_mm_interconnect_0_cmd_mux_002.sv"                           -work cmd_mux_002                                  -cdslib ./cds_libs/cmd_mux_002.cds.lib                                 
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_arbitrator.sv"                                                 -work cmd_mux_002                                  -cdslib ./cds_libs/cmd_mux_002.cds.lib                                 
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_master_agent.sv"                                               -work nios2_qsys_0_data_master_agent               -cdslib ./cds_libs/nios2_qsys_0_data_master_agent.cds.lib              
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_master_translator.sv"                                          -work nios2_qsys_0_data_master_translator          -cdslib ./cds_libs/nios2_qsys_0_data_master_translator.cds.lib         
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/vga_avalon.sv"                                                               -work vga                                          -cdslib ./cds_libs/vga.cds.lib                                         
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/vga_adapter.sv"                                                              -work vga                                          -cdslib ./cds_libs/vga.cds.lib                                         
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/vga_address_translator.sv"                                                   -work vga                                          -cdslib ./cds_libs/vga.cds.lib                                         
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/vga_controller.sv"                                                           -work vga                                          -cdslib ./cds_libs/vga.cds.lib                                         
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/vga_pll.sv"                                                                  -work vga                                          -cdslib ./cds_libs/vga.cds.lib                                         
