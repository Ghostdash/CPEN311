...
vcs -lca -timescale=1ps/1ps -sverilog +verilog2001ext+.v -ntb_opts dtm $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS \
  ...
  $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_mm_interconnect_0_cmd_mux_002.sv \
  ...
  $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/vga_adapter.sv \
  $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/vga_address_translator.sv \
  $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/vga_controller.sv \
  $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/vga_pll.sv \
  ...
  $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_nios2_qsys_0.v \
  $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_nios2_qsys_0_jtag_debug_module_sysclk.v \
  $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_nios2_qsys_0_jtag_debug_module_tck.v \
  $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_nios2_qsys_0_jtag_debug_module_wrapper.v \
  $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_nios2_qsys_0_oci_test_bench.v \
  $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_nios2_qsys_0_test_bench.v \
