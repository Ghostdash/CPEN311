...
mkdir -p ./libraries/wordcopy_0_avalon_master_limiter/
...
mkdir -p ./libraries/wordcopy_0_avalon_master_agent/
mkdir -p ./libraries/new_sdram_controller_0_s1_translator/
mkdir -p ./libraries/wordcopy_0_avalon_master_translator/
mkdir -p ./libraries/cpu/
mkdir -p ./libraries/rst_controller/
mkdir -p ./libraries/irq_mapper/
mkdir -p ./libraries/mm_interconnect_0/
mkdir -p ./libraries/wordcopy_0/
mkdir -p ./libraries/vga_avalon_0/
...
mkdir -p ./libraries/dotopt_0/
mkdir -p ./libraries/bank1/
mkdir -p ./libraries/bank0/
mkdir -p ./libraries/new_sdram_controller_0_my_partner/
mkdir -p ./libraries/dnn_accel_system_inst_vga_bfm/
...
if [ $SKIP_FILE_COPY -eq 0 ]; then
  ...
  cp -f $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_bank1.hex ./
  cp -f $QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_bank0.hex ./
fi
...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_mm_interconnect_0_rsp_mux_004.sv"                           -work rsp_mux_004                                 -cdslib ./cds_libs/rsp_mux_004.cds.lib                                
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_arbitrator.sv"                                                 -work rsp_mux_004                                 -cdslib ./cds_libs/rsp_mux_004.cds.lib                                
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_mm_interconnect_0_cmd_mux_004.sv"                           -work cmd_mux_004                                 -cdslib ./cds_libs/cmd_mux_004.cds.lib                                
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_arbitrator.sv"                                                 -work cmd_mux_004                                 -cdslib ./cds_libs/cmd_mux_004.cds.lib                                
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_mm_interconnect_0_cmd_demux_004.sv"                         -work cmd_demux_004                               -cdslib ./cds_libs/cmd_demux_004.cds.lib                              
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_mm_interconnect_0_cmd_demux_003.sv"                         -work cmd_demux_003                               -cdslib ./cds_libs/cmd_demux_003.cds.lib                              
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_traffic_limiter.sv"                                            -work wordcopy_0_avalon_master_limiter            -cdslib ./cds_libs/wordcopy_0_avalon_master_limiter.cds.lib           
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_reorder_memory.sv"                                             -work wordcopy_0_avalon_master_limiter            -cdslib ./cds_libs/wordcopy_0_avalon_master_limiter.cds.lib           
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_avalon_sc_fifo.v"                                                     -work wordcopy_0_avalon_master_limiter            -cdslib ./cds_libs/wordcopy_0_avalon_master_limiter.cds.lib           
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_avalon_st_pipeline_base.v"                                            -work wordcopy_0_avalon_master_limiter            -cdslib ./cds_libs/wordcopy_0_avalon_master_limiter.cds.lib           
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_mm_interconnect_0_router_009.sv"                            -work router_009                                  -cdslib ./cds_libs/router_009.cds.lib                                 
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_mm_interconnect_0_router_008.sv"                            -work router_008                                  -cdslib ./cds_libs/router_008.cds.lib                                 
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_master_agent.sv"                                               -work wordcopy_0_avalon_master_agent              -cdslib ./cds_libs/wordcopy_0_avalon_master_agent.cds.lib             
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_merlin_master_translator.sv"                                          -work wordcopy_0_avalon_master_translator         -cdslib ./cds_libs/wordcopy_0_avalon_master_translator.cds.lib        
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/wordcopy.sv"                                                                 -work wordcopy_0                                  -cdslib ./cds_libs/wordcopy_0.cds.lib                                 
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/vga_avalon.sv"                                                               -work vga_avalon_0                                -cdslib ./cds_libs/vga_avalon_0.cds.lib                               
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dotopt.sv"                                                                   -work dotopt_0                                    -cdslib ./cds_libs/dotopt_0.cds.lib                                   
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_bank1.v"                                                    -work bank1                                       -cdslib ./cds_libs/bank1.cds.lib                                      
  ncvlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/dnn_accel_system_bank0.v"                                                    -work bank0                                       -cdslib ./cds_libs/bank0.cds.lib                                      
  ...
  ncvlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/dnn_accel_system_tb/simulation/submodules/altera_conduit_bfm_0003.sv"                                                  -work dnn_accel_system_inst_vga_bfm               -cdslib ./cds_libs/dnn_accel_system_inst_vga_bfm.cds.lib              
